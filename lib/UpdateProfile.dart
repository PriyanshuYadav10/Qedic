                    ...
                    child: Container(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: _imagefile != null
                            ...
                            : _isValidImageUrl(picture)
                            ? NetworkImage(picture)
                            : null,
                        child: _imagefile == null && !_isValidImageUrl(picture)
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        errorText: fname_validate ? "Enter Frist Name" : null,
                  ...
                  Container(
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        errorText: lname_validate ? "Enter Last Name" : null,
                        border: OutlineInputBorder(),
                        enabledBorder: OutlineInputBorder(
                          borderSide: BorderSide(
                            color: HexColor(HexColor.gray_light),
  ...
  UpdateProfile(BuildContext context) async {
    ...
    try {
      ...
      var request = http.MultipartRequest(
        "POST",
        Uri.parse(Commons.updateProfile),
      );
      //add text fields
  ...
  ImageUload(XFile imagefile, BuildContext _context) async {
    ...
    try {
      ...
      if (response == null ||
        ...
        ImageUploadModel imageUploadModel = ImageUploadModel.fromJson(
          jsonDecode(response),
        );
